...
import com.jlcindia.bookstore.dao.RowMapper; 


public class JdbcTemplate { 
public static int update(String SQL,Object ...params) {
System.out.println("Jdbc Template-update()");
Connection con = null; 
...
x = ps.executeUpdate(); 
	...
	public static List<Object> queryForList(String SQL,RowMapper rowMapper, List<?> ...params) { 
	...
	List<Object> mylist = new ArrayList<Object>(); try { 
	con = DataSourceUtil.getConnection(); ps = con.prepareStatement(SQL); 
